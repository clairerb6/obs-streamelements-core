...
public:
    ...
    void setupUi(QDialog *StreamElementsReportIssueDialog)
    {
        if (StreamElementsReportIssueDialog->objectName().isEmpty())
            StreamElementsReportIssueDialog->setObjectName("StreamElementsReportIssueDialog");
        ...
        QObject::connect(cmdOK, &QPushButton::clicked, StreamElementsReportIssueDialog, qOverload<>(&QDialog::accept));
        QObject::connect(cmdCancel, &QPushButton::clicked, StreamElementsReportIssueDialog, qOverload<>(&QDialog::reject));
        QObject::connect(txtIssue, &QPlainTextEdit::textChanged, StreamElementsReportIssueDialog, qOverload<>(&QDialog::update));
